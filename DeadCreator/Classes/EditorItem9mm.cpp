...
EditorItem9mm::EditorItem9mm(GMXLayer& layer, int id) :
...
EditorItem9mm* EditorItem9mm::create(GMXLayer& layer, int id, const std::string& fileName, cocos2d::ui::Widget::TextureResType resType)
{
