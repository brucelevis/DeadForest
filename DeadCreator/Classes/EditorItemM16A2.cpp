...
EditorItemM16A2::EditorItemM16A2(GMXLayer& layer, int id) :
...
EditorItemM16A2* EditorItemM16A2::create(GMXLayer& layer, int id, const std::string& fileName, cocos2d::ui::Widget::TextureResType resType)
{
