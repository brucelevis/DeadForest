...
EditorItemM1897::EditorItemM1897(GMXLayer& layer, int id) :
...
EditorItemM1897* EditorItemM1897::create(GMXLayer& layer, int id, const std::string& fileName, cocos2d::ui::Widget::TextureResType resType)
{
