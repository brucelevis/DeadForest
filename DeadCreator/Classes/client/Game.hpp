...
namespace realtrick
{
	...
	namespace client
	{
		...
		public:
			...
			bool initWithSimulator(realtrick::editor::SimulatorLayer* simulator);

			static Game* create();
			static Game* createWithSimulator(realtrick::editor::SimulatorLayer* simulator);
			...
			realtrick::TileType getStepOnTileType(const cocos2d::Vec2& pos);
			...
			realtrick::SwitchStatus getSwitchStatus(int index) const;
