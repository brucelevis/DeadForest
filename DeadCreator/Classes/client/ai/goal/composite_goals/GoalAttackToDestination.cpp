...
GoalAttackToDestination::GoalAttackToDestination(HumanBase* const owner, const cocos2d::Vec2& destination, float arriveRange) :
GoalCompositeBase(owner),
_destination(destination),
_arriveRange(arriveRange)
{
    setGoalName("attack to destination");
