...
void GoalWander::activate()
{
    ...
    Vec2 randomDirection = Vec2(random(-100, 100), random(-100, 100)).getNormalized();
    
    _destination = _owner->getWorldPosition() + randomDirection * (kDefaultDistance + random(-kRandomErrorRange, kRandomErrorRange));
