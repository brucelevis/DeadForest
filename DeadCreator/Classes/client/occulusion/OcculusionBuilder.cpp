...
OcculusionBuilder* OcculusionBuilder::create(const Size& visibleSize)
{
...
bool OcculusionBuilder::init(const Size& visibleSize)
{
...
void OcculusionBuilder::invalidateTexture(cocos2d::RenderTexture* tex,
