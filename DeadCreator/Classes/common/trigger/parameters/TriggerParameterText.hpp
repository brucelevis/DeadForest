...
namespace realtrick
{
    namespace editor
    {
        ...
        public:
            ...
            TriggerParameterText() = default;
            explicit TriggerParameterText(GMXLayer* layer) : TriggerParameterBase(layer)
            {
                setParameterName("");
            }
            
            TriggerParameterText(const TriggerParameterText& rhs) : TriggerParameterBase(rhs) { copyFrom(rhs); }
