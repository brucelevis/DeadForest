...
namespace DeadCreator {
    ...
    enum SwitchStatus2 {
        SwitchStatus2_Clear = 0,
        SwitchStatus2_Set = 1,
        SwitchStatus2_Toggle = 2,
        SwitchStatus2_Randomize = 3,
        SwitchStatus2_MIN = SwitchStatus2_Clear,
        SwitchStatus2_MAX = SwitchStatus2_Randomize
    };
    
    inline const char **EnumNamesSwitchStatus2() {
        static const char *names[] = { "Clear", "Set", "Toggle", "Randomize", nullptr };
        return names;
    }
    ...
    struct ElapsedTime FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
        enum {
            VT_APPROXIMATION = 4,
            VT_NUMBER = 6
        };
    ...
    struct ElapsedTimeBuilder {
        flatbuffers::FlatBufferBuilder &fbb_;
        flatbuffers::uoffset_t start_;
        void add_approximation(Approximation approximation) { fbb_.AddElement<int32_t>(ElapsedTime::VT_APPROXIMATION, static_cast<int32_t>(approximation), 0); }
        void add_number(int32_t number) { fbb_.AddElement<int32_t>(ElapsedTime::VT_NUMBER, number, 0); }
        ElapsedTimeBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
        ElapsedTimeBuilder &operator=(const ElapsedTimeBuilder &);
        flatbuffers::Offset<ElapsedTime> Finish() {
            auto o = flatbuffers::Offset<ElapsedTime>(fbb_.EndTable(start_, 2));
            return o;
        }
    };
    
    inline flatbuffers::Offset<ElapsedTime> CreateElapsedTime(flatbuffers::FlatBufferBuilder &_fbb,
                                                              Approximation approximation = Approximation_AtLeast,
                                                              int32_t number = 0) {
    ...
    struct Switch FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
        ...
        const SwitchInfo *info() const { return GetPointer<const SwitchInfo *>(VT_INFO); }
        bool Verify(flatbuffers::Verifier &verifier) const {
            return VerifyTableStart(verifier) &&
    ...
    struct SwitchBuilder {
        flatbuffers::FlatBufferBuilder &fbb_;
        flatbuffers::uoffset_t start_;
        void add_info(flatbuffers::Offset<SwitchInfo> info) { fbb_.AddOffset(Switch::VT_INFO, info); }
        ...
        flatbuffers::Offset<Switch> Finish() {
            auto o = flatbuffers::Offset<Switch>(fbb_.EndTable(start_, 1));
            return o;
        }
    };
    
    inline flatbuffers::Offset<Switch> CreateSwitch(flatbuffers::FlatBufferBuilder &_fbb,
                                                    flatbuffers::Offset<SwitchInfo> info = 0) {
    ...
    struct MoveEntity FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
        enum {
            VT_NUMBERALL = 4,
            VT_ENTITY_TYPE = 6,
            VT_PLAYER = 8,
    ...
    struct MoveEntityBuilder {
        flatbuffers::FlatBufferBuilder &fbb_;
        flatbuffers::uoffset_t start_;
        void add_numberAll(int32_t numberAll) { fbb_.AddElement<int32_t>(MoveEntity::VT_NUMBERALL, numberAll, 0); }
        ...
        flatbuffers::Offset<MoveEntity> Finish() {
            auto o = flatbuffers::Offset<MoveEntity>(fbb_.EndTable(start_, 5));
            return o;
        }
    };
    
    inline flatbuffers::Offset<MoveEntity> CreateMoveEntity(flatbuffers::FlatBufferBuilder &_fbb,
                                                            int32_t numberAll = 0,
                                                            int32_t entity_type = 0,
                                                            int32_t player = 0,
    ...
    struct PauseGame FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
        bool Verify(flatbuffers::Verifier &verifier) const {
            return VerifyTableStart(verifier) &&
            verifier.EndTable();
        }
    ...
    struct PauseGameBuilder {
        flatbuffers::FlatBufferBuilder &fbb_;
        flatbuffers::uoffset_t start_;
        PauseGameBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
        PauseGameBuilder &operator=(const PauseGameBuilder &);
        flatbuffers::Offset<PauseGame> Finish() {
            auto o = flatbuffers::Offset<PauseGame>(fbb_.EndTable(start_, 0));
            return o;
        }
    };
    
    inline flatbuffers::Offset<PauseGame> CreatePauseGame(flatbuffers::FlatBufferBuilder &_fbb) {
        PauseGameBuilder builder_(_fbb);
        return builder_.Finish();
    }
    
    struct ResumeGame FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
        bool Verify(flatbuffers::Verifier &verifier) const {
            return VerifyTableStart(verifier) &&
            verifier.EndTable();
        }
    ...
    struct ResumeGameBuilder {
        flatbuffers::FlatBufferBuilder &fbb_;
        flatbuffers::uoffset_t start_;
        ResumeGameBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
        ResumeGameBuilder &operator=(const ResumeGameBuilder &);
        flatbuffers::Offset<ResumeGame> Finish() {
            auto o = flatbuffers::Offset<ResumeGame>(fbb_.EndTable(start_, 0));
            return o;
        }
    };
    
    inline flatbuffers::Offset<ResumeGame> CreateResumeGame(flatbuffers::FlatBufferBuilder &_fbb) {
        ResumeGameBuilder builder_(_fbb);
        return builder_.Finish();
    }
    ...
    struct SetSwitch FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
        enum {
            VT_INFO = 4
        };
        const SwitchInfo2 *info() const { return GetPointer<const SwitchInfo2 *>(VT_INFO); }
        bool Verify(flatbuffers::Verifier &verifier) const {
            return VerifyTableStart(verifier) &&
            VerifyField<flatbuffers::uoffset_t>(verifier, VT_INFO) &&
            verifier.VerifyTable(info()) &&
    ...
    struct SetSwitchBuilder {
        flatbuffers::FlatBufferBuilder &fbb_;
        flatbuffers::uoffset_t start_;
        void add_info(flatbuffers::Offset<SwitchInfo2> info) { fbb_.AddOffset(SetSwitch::VT_INFO, info); }
        SetSwitchBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
        SetSwitchBuilder &operator=(const SetSwitchBuilder &);
        flatbuffers::Offset<SetSwitch> Finish() {
            auto o = flatbuffers::Offset<SetSwitch>(fbb_.EndTable(start_, 1));
            return o;
        }
    };
    
    inline flatbuffers::Offset<SetSwitch> CreateSetSwitch(flatbuffers::FlatBufferBuilder &_fbb,
    ...
    struct EntityBuilder {
        ...
        void add_name(flatbuffers::Offset<flatbuffers::String> name) { fbb_.AddOffset(Entity::VT_NAME, name); }
    ...
    struct SwitchInfo FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
        enum {
            VT_NAME = 4,
            VT_STATUS = 6,
            VT_INDEX = 8
    ...
    struct SwitchInfoBuilder {
        flatbuffers::FlatBufferBuilder &fbb_;
        flatbuffers::uoffset_t start_;
        void add_name(flatbuffers::Offset<flatbuffers::String> name) { fbb_.AddOffset(SwitchInfo::VT_NAME, name); }
        void add_status(SwitchStatus status) { fbb_.AddElement<int32_t>(SwitchInfo::VT_STATUS, static_cast<int32_t>(status), 0); }
        void add_index(int32_t index) { fbb_.AddElement<int32_t>(SwitchInfo::VT_INDEX, index, 0); }
        SwitchInfoBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
        SwitchInfoBuilder &operator=(const SwitchInfoBuilder &);
        flatbuffers::Offset<SwitchInfo> Finish() {
            auto o = flatbuffers::Offset<SwitchInfo>(fbb_.EndTable(start_, 3));
            return o;
        }
    };
    
    inline flatbuffers::Offset<SwitchInfo> CreateSwitchInfo(flatbuffers::FlatBufferBuilder &_fbb,
                                                            flatbuffers::Offset<flatbuffers::String> name = 0,
                                                            SwitchStatus status = SwitchStatus_Cleared,
                                                            int32_t index = 0) {
        SwitchInfoBuilder builder_(_fbb);
    ...
    struct SwitchInfo2 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
        enum {
            VT_NAME = 4,
            VT_STATUS = 6,
            VT_INDEX = 8
        ...
        const flatbuffers::String *name() const { return GetPointer<const flatbuffers::String *>(VT_NAME); }
        SwitchStatus2 status() const { return static_cast<SwitchStatus2>(GetField<int32_t>(VT_STATUS, 0)); }
        int32_t index() const { return GetField<int32_t>(VT_INDEX, 0); }
        bool Verify(flatbuffers::Verifier &verifier) const {
            return VerifyTableStart(verifier) &&
            VerifyField<flatbuffers::uoffset_t>(verifier, VT_NAME) &&
    ...
    struct SwitchInfo2Builder {
        flatbuffers::FlatBufferBuilder &fbb_;
        flatbuffers::uoffset_t start_;
        void add_name(flatbuffers::Offset<flatbuffers::String> name) { fbb_.AddOffset(SwitchInfo2::VT_NAME, name); }
        void add_status(SwitchStatus2 status) { fbb_.AddElement<int32_t>(SwitchInfo2::VT_STATUS, static_cast<int32_t>(status), 0); }
        void add_index(int32_t index) { fbb_.AddElement<int32_t>(SwitchInfo2::VT_INDEX, index, 0); }
        SwitchInfo2Builder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
        SwitchInfo2Builder &operator=(const SwitchInfo2Builder &);
        flatbuffers::Offset<SwitchInfo2> Finish() {
            auto o = flatbuffers::Offset<SwitchInfo2>(fbb_.EndTable(start_, 3));
            return o;
        }
    };
    
    inline flatbuffers::Offset<SwitchInfo2> CreateSwitchInfo2(flatbuffers::FlatBufferBuilder &_fbb,
                                                              flatbuffers::Offset<flatbuffers::String> name = 0,
                                                              SwitchStatus2 status = SwitchStatus2_Clear,
                                                              int32_t index = 0) {
        SwitchInfo2Builder builder_(_fbb);
        builder_.add_index(index);
        builder_.add_status(status);
        builder_.add_name(name);
        return builder_.Finish();
    ...
    struct GMXFile FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
        ...
        const flatbuffers::Vector<flatbuffers::Offset<SwitchInfo>> *switch_infos() const { return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<SwitchInfo>> *>(VT_SWITCH_INFOS); }
        ...
        bool Verify(flatbuffers::Verifier &verifier) const {
            ...
            VerifyField<flatbuffers::uoffset_t>(verifier, VT_SWITCH_INFOS) &&
            verifier.Verify(switch_infos()) &&
            verifier.VerifyVectorOfTables(switch_infos()) &&
    ...
    struct GMXFileBuilder {
        ...
        void add_switch_infos(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SwitchInfo>>> switch_infos) { fbb_.AddOffset(GMXFile::VT_SWITCH_INFOS, switch_infos); }
    ...
    inline flatbuffers::Offset<GMXFile> CreateGMXFile(flatbuffers::FlatBufferBuilder &_fbb,
                                                      ...
                                                      flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<SwitchInfo>>> switch_infos = 0,
        ...
        builder_.add_switch_infos(switch_infos);
