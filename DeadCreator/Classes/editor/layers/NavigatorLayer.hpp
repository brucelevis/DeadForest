    ...
    namespace editor
    {
        ...
        public:
            ...
            virtual bool init() override
            {
                ...
                if ( _defaultTile == TileType::DIRT ) _defaultTileTextureName = cocos2d::Director::getInstance()->getTextureCache()->addImage("editor/tiles/default_tile_dirt.png")->getName();
                else if ( _defaultTile == TileType::GRASS ) _defaultTileTextureName = cocos2d::Director::getInstance()->getTextureCache()->addImage("editor/tiles/default_tile_grass.png")->getName();
                else if ( _defaultTile == TileType::WATER ) _defaultTileTextureName = cocos2d::Director::getInstance()->getTextureCache()->addImage("editor/tiles/default_tile_water.png")->getName();
                else if ( _defaultTile == TileType::HILL ) _defaultTileTextureName = cocos2d::Director::getInstance()->getTextureCache()->addImage("editor/tiles/default_tile_hill.png")->getName();
            ...
            void setTile(int x, int y, const Tileset& tile)
            {
                ...
                else
                {
                    ...
                    {
                        _tileMarks[key] = reinterpret_cast<ImTextureID>(cocos2d::Director::getInstance()->getTextureCache()->addImage("editor/tiles/dirt_mark.png")->getName());
                    }
                    else if ( tile.getTileType() == TileType::GRASS )
                    {
                        _tileMarks[key] = reinterpret_cast<ImTextureID>(cocos2d::Director::getInstance()->getTextureCache()->addImage("editor/tiles/grass_mark.png")->getName());
                    }
                    else if ( tile.getTileType() == TileType::WATER )
                    {
                        _tileMarks[key] = reinterpret_cast<ImTextureID>(cocos2d::Director::getInstance()->getTextureCache()->addImage("editor/tiles/water_mark.png")->getName());
                    }
                    else if ( tile.getTileType() == TileType::HILL )
                    {
                        _tileMarks[key] = reinterpret_cast<ImTextureID>(cocos2d::Director::getInstance()->getTextureCache()->addImage("editor/tiles/hill_mark.png")->getName());
                    }
                }
            }
