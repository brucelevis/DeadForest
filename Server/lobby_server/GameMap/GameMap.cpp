...
namespace realtrick
{
    ...
    std::vector<geometry::Segment> GameMap::getNeighborWall(const Vec2 position) const
    {
        std::vector<geometry::Segment> ret;
        
        return ret;
    }
        
    GameMap::TileType GameMap::getStepOnTileType(const Vec2& pos)
    {
