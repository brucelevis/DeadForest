...
namespace realtrick
{
    ...
    public:
        ...
        void invalidateTexture(cocos2d::RenderTexture* tex, const cocos2d::Vec2& worldPos, const std::vector<Polygon>& polygons, const cocos2d::Size& boundarySize, const FieldOfView& fov);
