...
namespace realtrick
{
    ...
    void Mat3::rotate(const Vec2& heading, const Vec2& side)
    {
        Mat3 rotateMat;
    ...
    Vec2 Mat3::getTransformedVector(const Vec2& v)
    {
        Vec2 ret;
    ...
    std::vector<Vec2> Mat3::getTransformedVector(std::vector<Vec2> v)
    {
        std::vector<Vec2> ret;
        for( auto &d : v)
        {
